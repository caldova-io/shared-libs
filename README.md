# Caldova Shared Libraries

Shared utilities and service contracts used by Caldova platform services.
...
python -c "import caldova_shared"
```
...
Contracts are stored in `proto/caldova/contracts/v1/shared.proto` and cover orders, delivery windows, and robot telemetry.
